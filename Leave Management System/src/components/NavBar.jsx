            ...
            <div>
                ...
                <NavLink to='/'>{({ isActive }) => isActive ?  
                    <div className='relative bg-black w-60 h-screen flex flex-col items-center justify-evenly'>
                        ...
                        <div className='absolute text-xl w-full items-center ml-5 '>
                        ...
                        <div className='absolute bottom-10 flex flex-col gap-y-3 text-xl font-bold'>
                            <button className=' py-2 px-4 shadow shadow-white rounded-xl border-gray-400 text-gray-300 hover:text-black hover:bg-white'><NavLink to="/login"
                            >
                                Login
                            </NavLink>
                            </button>
